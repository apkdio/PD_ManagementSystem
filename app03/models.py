...
class Department(models.Model):
    ...
    master = models.ForeignKey(verbose_name="部长", to="app03.Userinfo", null=True, blank=True,
...
class Userinfo(models.Model):
    ...
    depart = models.ForeignKey(verbose_name="部门", to="app03.Department", null=True, blank=True,
...
class SuperManager(models.Model):
    ...
    depart = models.ForeignKey(verbose_name="负责部门", to="app03.Department", null=True, blank=True,
                               on_delete=models.SET_NULL)


class Consumer(models.Model):
    name = models.CharField(verbose_name="客户姓名", max_length=30)
    number = models.CharField(verbose_name="客户电话", max_length=11)
    money = models.DecimalField(verbose_name="客户余额", max_digits=20, decimal_places=2, default=0)
    president = models.ForeignKey(verbose_name="负责人", to="app03.Userinfo", null=True,
                                  blank=True, on_delete=models.SET_NULL)


class Logging(models.Model):
    time = models.DateTimeField(auto_now_add=True)
    action = models.CharField(verbose_name="操作", max_length=30, null=False, blank=False)
    operate_user = models.CharField(verbose_name="操作人", max_length=30, null=False, blank=False)
    operate_object = models.CharField(verbose_name="操作详情", max_length=100, null=True, blank=True)
